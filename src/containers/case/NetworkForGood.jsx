...
export default class NetworkForGood extends React.Component {
      ...
      <div>
        ...
        <div id="networkforgood" className="case-header">
          <div className="case-hero">
            <h1 className="case-headline stix-bi">Network For Good</h1>
            <h3 className="case-tagline stix-reg">Accelerating micro-philanthropy</h3>
          </div>
        </div>
        ...
        <div className="case-content">
          ...
          <div className="content-main">
            ...
            <img className="example" src={require("../../img/case/networkforgood-ex2.png")}  />
          </div>
